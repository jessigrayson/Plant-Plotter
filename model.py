...
class User(db.Model):
    ...
    zipcode = db.Column(db.String(15), nullable=False) #This may need to be city?
...
# SHOULD I MAKE GARDEN LOCATION A BOOLEAN?
    ...
    users = relationship("User", backref=UserGarden)

    def __repr__(self):
        """Provide helpful representation when printed."""

        return """<Water_id={self.garden_id} water name={self.garden_name}.>"""
